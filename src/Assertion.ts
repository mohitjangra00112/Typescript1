...
let n:number=(response as string).length;  // response as string is forcufully converting any to string
...
const inputEle = document.getElementById("abcd") as HTMLInputElement;
...
const data:string="chai";
const strData:string=data as string;


////////////////////  Never type ///////////////////

// never is shown when we hover a variable , never shows this value should not exist
// ex.
